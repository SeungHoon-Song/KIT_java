...
public class HashSetEx02 {
	...
	public static void main(String[] args) {
		...
		int[] intArr = {100,90,80,70,100,40,90};	//전교생으 ㅣ점수를 입력하고 학생들이 취득한 점수의 내용
		//우리 회사에 직위는 ? 사장, 과장, 대리, 팀장, 사원
		String[] strArr = {"사장", "과장","대리","팀장","사원","사장","과장","사장","과장","대리","팀장","사원"};
...
//		Set<String> sh = new HashSet<String>();
		...
		Set<Integer> ih =new LinkedHashSet<Integer>();
		Set<String> sh = new LinkedHashSet<String>();
